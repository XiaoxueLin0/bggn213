...
Next, get results for the HoxA1 knockdown versus control siRNA (labeled as “hoxa1\_kd” and “control\_sirna” in our original colData metaFile input to DESeq). Check this by running **resultsNames(dds)** command.
...
![](Class15_RMarkdown_files/figure-markdown_github/unnamed-chunk-14-1.png)
...
Like any list we can use the dollar syntax to access a named element, e.g. **head(keggres*g**r**e**a**t**e**r*)\* \* *a**n**d* \* \**h**e**a**d*(*k**e**g**g**r**e**s*less)**.
...
```
    ...
    ## Info: Working in directory /Users/xiaoxuelin/Desktop/PhD/Winter 2019/BGGN213/bggn213_github/Class15
